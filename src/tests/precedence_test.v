...
{:__aliases__, [line: 1], [:PrecedenceTest]},
  [{:do, {:def, [line: 2,type: SUM::integer_], [
    {:main, [line: 2,type: SUM::integer_], []},
        [{:do, {:+, [line: 3,type: integer_], [
        {:-, [line: 3,type: integer_], [
            {:-, [line: 3,type: integer_], [
                {:+, [line: 3,type: integer_], [{:+, [line: 3,type: integer_], [1,2]},3]},
                2]},
            {:/, [line: 3,type: integer_], [
                {:*, [line: 3,type: integer_], [{:/, [line: 3,type: integer_], [5,2]},3]},
                4]}]},
        {:/, [line: 3,type: integer_], [
            5,
            {:+, [line: 3,inside_parens: true,type: integer_], [1,2]}]}]}}]]}}]]}}' == bin.program.modules['PrecedenceTest'].str()
