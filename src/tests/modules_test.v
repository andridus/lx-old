...
pub fn test_lexer_ex_file() {
	...
	assert '{{:defmodule, [line: 1], [{:__aliases__, [line: 1], [:B]},[{:do,{:def, [line: 2,type: SUM::float_], [{:one, [line: 2,type: SUM::float_], []},[{:do,2.0}]]}}]]},{:defmodule, [line: 1], [{:__aliases__, [line: 1], [:A]},[{:do,{:def, [line: 2,type: SUM::float_], [{:main, [line: 2,type: SUM::float_], []},[{:do,{:{:., [line: 3,type: float_], [{:__aliases__, [line: 3,type: float_], [:B]},:one]}, [line: 3,type: float_], []}}]]}}]]}}' == bin.program.modules['A'].str()
